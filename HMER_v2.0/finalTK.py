...
root.title('AI第一组-基于Attenion机制的DenseNet-GRU手写数学公式识别')
Flag = True

menubar = tkinter.Menu(root)
filemenu = tkinter.Menu(menubar, tearoff=0)
menubar.add_cascade(label='开始', font=("Times New Roman", 15, 'bold'), menu=filemenu)
filemenu.add_command(label='载入图片', font=("Times New Roman", 15, 'bold'), command=choosepic)
filemenu.add_command(label='保存图片', font=("Times New Roman", 15, 'bold'), command=saveClick)
filemenu.add_separator()
filemenu.add_command(label='退出', font=("Times New Roman", 15, 'bold'), command=root.quit)

path = StringVar()
bu1 = Button(root, text='开始预测', font=('Times New Roman', 15, 'bold'), width=18, height=2, bg="#4CAF50", fg="white", command=trans1)
bu2 = Button(root, text='查看动态识别细节', font=('Times New Roman', 15, 'bold'), width=18, height=2, bg="#2196F3", fg="white", command=trans)
bu3 = Button(root, text='显示公式', font=('Times New Roman', 15, 'bold'), width=18, height=2, bg="#FFC107", fg="white", command=trans2)
e1 = Entry(root, state='readonly', text=path)
title = tkinter.Label(root,
                      text='基于Attenion机制的DenseNet-GRU手写数学公式识别',
...
title_2.place(relx=0.05, y=550)
title_3.place(relx=0.55, y=200)
title_4.place(relx=0.55, y=550)

l1 = Label(root, borderwidth=2, relief="solid")
l1.place(relx=0.05, y=250, width=700, height=200)
l2 = Label(root, borderwidth=2, relief="solid")
l2.place(relx=0.55, y=250, width=700, height=200)
img_trans_show = Label(root)
img_trans_show.place(x=550, y=150)
root.config(menu=menubar)

e2 = Label(root, borderwidth=2, relief="solid", font=('Arial', 25))
e2.place(relx=0.05, y=600,width=700, height=200)
e3 = Label(root, borderwidth=2, relief="solid", font=('Arial', 25))
e3.place(relx=0.55, y=600, width=700, height=200)
